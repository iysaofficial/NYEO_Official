    ...
    return(
        ...
        <header>
            <Link href="/">
                <Image 
                    className='logo-nav' 
                    src="/assets/images/logo/NYEO.png" 
                    alt="NYEO Logo" 
                    width={100} 
                    height={50}
                    priority
            ...
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item'>
                        <Link href="https://drive.google.com/file/d/1zdAtdEOzqNWfi1F6nPTv8jwr-0fP1c_Q/view?usp=sharing" 
                            target='_blank'
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1v58n26x4NTxWHM3n6pgc79eh_lquzkOF?usp=sharing" 
                                    target='_blank'
                                    rel="noopener noreferrer">
